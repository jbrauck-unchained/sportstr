...
def extract_latest_headline(articles):
    ...
    media_url = latest_article.media_thumbnail[0]['url'] if latest_article.media_thumbnail else None

    return headline, link, media_url

def main():
    feed_type = "PHILLY"
    feed_url = "https://www.phillyvoice.com/feed/channel/philly-sports/"
